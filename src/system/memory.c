...
//!----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
static MEMExpHeap * mem1_heap = NULL;
static MEMExpHeap * bucket_heap = NULL;

void memoryInitialize(void)
{
    if(!mem1_heap)
    {
        MEMFrmHeap * mem1_heap_handle = MEMGetBaseHeapHandle(MEMORY_ARENA_1);
    ...
    if(!bucket_heap)
    {
        MEMFrmHeap * bucket_heap_handle = MEMGetBaseHeapHandle(MEMORY_ARENA_FG_BUCKET);
